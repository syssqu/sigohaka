...
RSpec.describe "transportation_expresses/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit transportation_express form" do
    render

    assert_select "form[action=?][method=?]", transportation_express_path(@transportation_express), "post" do
