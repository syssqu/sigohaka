...
describe "summary_attendances/new" do
  before(:each) do
    assign(:summary_attendance, stub_model(SummaryAttendance,
      :user_id => 1,
      :year => "MyString",
      :month => "MyString",
      :previous_m => 1,
  ...
  it "renders new summary_attendance form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", summary_attendances_path, "post" do
