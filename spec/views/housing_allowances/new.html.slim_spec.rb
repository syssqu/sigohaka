...
describe "housing_allowances/new" do
  before(:each) do
    assign(:housing_allowance, stub_model(HousingAllowance,
      :user_id => 1,
      :year => "MyString",
      :month => "MyString",
      :reason => "MyString",
  ...
  it "renders new housing_allowance form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", housing_allowances_path, "post" do
